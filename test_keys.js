...
//       checkKeyObj.structure(keySEC, keyObject);
//       checkKeyObj.values(keySEC, t, keyObject);
//       keySEC.importFromFile(t.input.address, t.input.datadir, function (keyObj) {
//         checkKeyObj.structure(keySEC, keyObj);
//         checkKeyObj.values(keySEC, t, keyObj);
//         done();
//       });
...
//       // synchronous
//       dk = keySEC.recover(t.input.password, t.input.keyObject);
//       assert.strictEqual(dk.toString("hex"), t.expected);

//       // asynchronous
//       keySEC.recover(t.input.password, t.input.keyObject, function (dk) {
//         assert.strictEqual(dk.toString("hex"), t.expected);
//         done();
//       });
//     });
...
//     assert.throws(function () { keySEC.recover("barfoo", foobarKeyObject); }, "message authentication code mismatch");
//     keySEC.recover("barfoo", foobarKeyObject, function (err) {
